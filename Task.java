...
public class Task061 {
    ...
    public static ArrayList<Laptop> getLaptopList() {
        ...
        Laptop justLaptop = new Laptop("Just Laptop", "White", 16, 512, "DOS");
        Laptop macbook = new Laptop("Apple MacBook Pro 13\"", "Silver", 8, 256, "MacOS");
        Laptop asus = new Laptop("ASUS Vivobook Pro n7600z", "Black", 2, 32, "Windows 10 Home");
